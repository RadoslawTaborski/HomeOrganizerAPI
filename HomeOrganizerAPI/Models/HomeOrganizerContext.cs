    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Category>(entity =>
        {
            ...
            entity.HasIndex(e => e.GroupUuid)
                .HasDatabaseName("fk_category_group1_idx");

            entity.HasIndex(e => e.Uuid)
                .HasDatabaseName("uuid")
                .IsUnique();
        ...
        modelBuilder.Entity<ListCategory>(entity =>
        {
            ...
            entity.HasIndex(e => e.GroupUuid)
                .HasDatabaseName("fk_list_category_group1_idx");
        ...
        modelBuilder.Entity<ExpenseDetails>(entity =>
        {
            ...
            entity.HasIndex(e => e.ExpenseUuid)
                .HasDatabaseName("fk_expense_details_expenses1_idx");

            entity.HasIndex(e => e.PayerUuid)
                .HasDatabaseName("fk_expense_details_user2_idx");

            entity.HasIndex(e => e.RecipientUuid)
                .HasDatabaseName("fk_expense_details_user1_idx");
        ...
        modelBuilder.Entity<Expenses>(entity =>
        {
            ...
            entity.HasIndex(e => e.GroupUuid)
                .HasDatabaseName("fk_expenses_group1_idx");
        ...
        modelBuilder.Entity<ExpensesSettings>(entity =>
        {
            ...
            entity.HasIndex(e => e.UserGroupsUuid)
                .HasDatabaseName("fk_expenses_settings_user_groups1_idx");
        ...
        modelBuilder.Entity<Item>(entity =>
        {
            ...
            entity.HasIndex(e => e.CategoryUuid)
                .HasDatabaseName("fk_item_subcategory1_idx");

            entity.HasIndex(e => e.GroupUuid)
                .HasDatabaseName("fk_item_group1_idx");

            entity.HasIndex(e => e.ShoppingListUuid)
                .HasDatabaseName("fk_item_shopping_list1_idx");

            entity.HasIndex(e => e.StateUuid)
                .HasDatabaseName("fk_item_state1_idx");
        ...
        modelBuilder.Entity<ShoppingList>(entity =>
        {
            ...
            entity.HasIndex(e => e.GroupUuid)
                .HasDatabaseName("fk_shopping_list_group1_idx");

            entity.HasIndex(e => e.GroupUuid)
                .HasDatabaseName("fk_shopping_list_category1");
        ...
        modelBuilder.Entity<Subcategory>(entity =>
        {
            ...
            entity.HasIndex(e => e.CategoryUuid)
                .HasDatabaseName("fk_subcategory_category1_idx");

            entity.HasIndex(e => e.GroupUuid)
                .HasDatabaseName("fk_subcategory_group1_idx");
        ...
        modelBuilder.Entity<UserGroups>(entity =>
        {
            ...
            entity.HasIndex(e => e.GroupUuid)
                .HasDatabaseName("fk_user_groups_group1_idx");

            entity.HasIndex(e => e.UserUuid)
                .HasDatabaseName("fk_user_groups_user1_idx");
