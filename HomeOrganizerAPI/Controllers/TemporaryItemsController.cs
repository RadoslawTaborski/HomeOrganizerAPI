...
namespace HomeOrganizerAPI.Controllers
{
    ...
    [ApiController]
    public class TemporaryItemsController : BaseController<Item, TemporaryItem, Dto, TemporaryItemsResourceParameters>
    {
        private IPermissionChecker _checker;
        public TemporaryItemsController(TemporaryItemsRepository repo, IPermissionChecker checker) : base(repo)
        {
            _checker = checker;
        }

        protected override async Task<bool> HasAccessGet(ClaimsPrincipal user, TemporaryItemsResourceParameters resourceParameters)
        {
