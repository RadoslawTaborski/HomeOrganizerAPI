...
namespace HomeOrganizerAPI.Controllers
{
    ...
    public class StatesController : Controller
    {
        ...
        public StatesController(HomeOrganizerContext context)
        {
            _context = context;
        }
        ...
        {
            var entity = await _context.State.FindAsync(id);
            if (entity == null)
            {
                return NotFound();
            }
        ...
        {
            _context.State.Add(Dto.ToObject(value));
            await _context.SaveChangesAsync();

            return CreatedAtAction(nameof(State), new { id = value.Id }, value);
        }
